...
public class LyraResultSet implements ResultSet {
    ...
    public int getInt(int columnIndex) throws SQLException {
        ...
        try {
            ...
            throw new SQLException("Type is not a integer.");
        }
    }
    ...
    public String getString(String columnLabel) throws SQLException {
        if (!columnNames.contains(columnLabel)) {
            throw new SQLException("The column label is not exist.");
        }
        return rows.get(position).get(columnLabel).toString();
    }
    ...
    public int getInt(String columnLabel) throws SQLException {
        ...
        try {
            return Integer.parseInt(rows.get(position).get(columnLabel).toString());
        } catch (NumberFormatException e) {
            throw new SQLException("Type is not a integer.");
        }
    }
